#!/bin/bash
# ╔══════════════════════════════════════════════════════════════════╗
# ║ COMFYUI + FLUX DEV — TAM PAKET (setup_full.sh)                  ║
...
# ── 3. CUSTOM NODE'LAR ─────────────────────────────────────────────
step "ADIM 3/6: Custom Node'lar (Paralel)"
...
download "https://huggingface.co/Kijai/flux-fp8/resolve/main/flux1-dev-fp8.safetensors" \
         "models/unet" "flux1-dev-fp8.safetensors" "Flux.1 Dev FP8 (~11.9 GB)"
...
# C. VAE (public mirror - gated değil)
...
# H. IP-Adapter (hem xlabs hem ipadapter klasörüne)
...
# IP-Adapter'ı cubiq node'unun da görmesi için
